...
static PyObject *__pyx_pf_8sealcore_4Pycoherent_skymap_bicorr(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_coh_skymap_bicorr, __Pyx_memviewslice __pyx_v_time_arrays, __Pyx_memviewslice __pyx_v_snr_arrays, __Pyx_memviewslice __pyx_v_detector_codes, __Pyx_memviewslice __pyx_v_sigmas, __Pyx_memviewslice __pyx_v_ntimes, int __pyx_v_Ndet, __Pyx_memviewslice __pyx_v_ra_grids, __Pyx_memviewslice __pyx_v_dec_grids, int __pyx_v_ngrid, double __pyx_v_start_time, double __pyx_v_end_time, int __pyx_v_ntime_interp, double __pyx_v_prior_mu, double __pyx_v_prior_sigma, int __pyx_v_nthread); /* proto */
...
/* "sealgw/calculation/cealcore.pyx":37
 *
 *
...
static PyObject *__pyx_pw_8sealcore_5Pycoherent_skymap_bicorr(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("Pycoherent_skymap_bicorr (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_time_arrays)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("Pycoherent_skymap_bicorr", 1, 16, 16, 1); __PYX_ERR(0, 37, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_snr_arrays)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("Pycoherent_skymap_bicorr", 1, 16, 16, 2); __PYX_ERR(0, 37, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_detector_codes)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("Pycoherent_skymap_bicorr", 1, 16, 16, 3); __PYX_ERR(0, 37, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_sigmas)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("Pycoherent_skymap_bicorr", 1, 16, 16, 4); __PYX_ERR(0, 37, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  5:
        if (likely((values[5] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_ntimes)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("Pycoherent_skymap_bicorr", 1, 16, 16, 5); __PYX_ERR(0, 37, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  6:
        if (likely((values[6] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_Ndet)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("Pycoherent_skymap_bicorr", 1, 16, 16, 6); __PYX_ERR(0, 37, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  7:
        if (likely((values[7] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_ra_grids)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("Pycoherent_skymap_bicorr", 1, 16, 16, 7); __PYX_ERR(0, 37, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  8:
        if (likely((values[8] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_dec_grids)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("Pycoherent_skymap_bicorr", 1, 16, 16, 8); __PYX_ERR(0, 37, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  9:
        if (likely((values[9] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_ngrid)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("Pycoherent_skymap_bicorr", 1, 16, 16, 9); __PYX_ERR(0, 37, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case 10:
        if (likely((values[10] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_start_time)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("Pycoherent_skymap_bicorr", 1, 16, 16, 10); __PYX_ERR(0, 37, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case 11:
        if (likely((values[11] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_end_time)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("Pycoherent_skymap_bicorr", 1, 16, 16, 11); __PYX_ERR(0, 37, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case 12:
        if (likely((values[12] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_ntime_interp)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("Pycoherent_skymap_bicorr", 1, 16, 16, 12); __PYX_ERR(0, 37, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case 13:
        if (likely((values[13] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_prior_mu)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("Pycoherent_skymap_bicorr", 1, 16, 16, 13); __PYX_ERR(0, 37, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case 14:
        if (likely((values[14] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_prior_sigma)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("Pycoherent_skymap_bicorr", 1, 16, 16, 14); __PYX_ERR(0, 37, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case 15:
        if (likely((values[15] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_nthread)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("Pycoherent_skymap_bicorr", 1, 16, 16, 15); __PYX_ERR(0, 37, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "Pycoherent_skymap_bicorr") < 0)) __PYX_ERR(0, 37, __pyx_L3_error)
      }
    ...
    __pyx_v_coh_skymap_bicorr = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_coh_skymap_bicorr.memview)) __PYX_ERR(0, 38, __pyx_L3_error)
    __pyx_v_time_arrays = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_time_arrays.memview)) __PYX_ERR(0, 39, __pyx_L3_error)
    __pyx_v_snr_arrays = __Pyx_PyObject_to_MemoryviewSlice_ds___pyx_t_double_complex(values[2], PyBUF_WRITABLE); if (unlikely(!__pyx_v_snr_arrays.memview)) __PYX_ERR(0, 40, __pyx_L3_error)
    __pyx_v_detector_codes = __Pyx_PyObject_to_MemoryviewSlice_ds_int(values[3], PyBUF_WRITABLE); if (unlikely(!__pyx_v_detector_codes.memview)) __PYX_ERR(0, 41, __pyx_L3_error)
    __pyx_v_sigmas = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[4], PyBUF_WRITABLE); if (unlikely(!__pyx_v_sigmas.memview)) __PYX_ERR(0, 42, __pyx_L3_error)
    __pyx_v_ntimes = __Pyx_PyObject_to_MemoryviewSlice_ds_int(values[5], PyBUF_WRITABLE); if (unlikely(!__pyx_v_ntimes.memview)) __PYX_ERR(0, 43, __pyx_L3_error)
    __pyx_v_Ndet = __Pyx_PyInt_As_int(values[6]); if (unlikely((__pyx_v_Ndet == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 44, __pyx_L3_error)
    __pyx_v_ra_grids = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[7], PyBUF_WRITABLE); if (unlikely(!__pyx_v_ra_grids.memview)) __PYX_ERR(0, 45, __pyx_L3_error)
    __pyx_v_dec_grids = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[8], PyBUF_WRITABLE); if (unlikely(!__pyx_v_dec_grids.memview)) __PYX_ERR(0, 46, __pyx_L3_error)
    __pyx_v_ngrid = __Pyx_PyInt_As_int(values[9]); if (unlikely((__pyx_v_ngrid == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 47, __pyx_L3_error)
    __pyx_v_start_time = __pyx_PyFloat_AsDouble(values[10]); if (unlikely((__pyx_v_start_time == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 48, __pyx_L3_error)
    __pyx_v_end_time = __pyx_PyFloat_AsDouble(values[11]); if (unlikely((__pyx_v_end_time == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 49, __pyx_L3_error)
    __pyx_v_ntime_interp = __Pyx_PyInt_As_int(values[12]); if (unlikely((__pyx_v_ntime_interp == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 50, __pyx_L3_error)
    __pyx_v_prior_mu = __pyx_PyFloat_AsDouble(values[13]); if (unlikely((__pyx_v_prior_mu == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 51, __pyx_L3_error)
    __pyx_v_prior_sigma = __pyx_PyFloat_AsDouble(values[14]); if (unlikely((__pyx_v_prior_sigma == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 52, __pyx_L3_error)
    __pyx_v_nthread = __Pyx_PyInt_As_int(values[15]); if (unlikely((__pyx_v_nthread == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 53, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("Pycoherent_skymap_bicorr", 1, 16, 16, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 37, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("sealcore.Pycoherent_skymap_bicorr", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_8sealcore_4Pycoherent_skymap_bicorr(__pyx_self, __pyx_v_coh_skymap_bicorr, __pyx_v_time_arrays, __pyx_v_snr_arrays, __pyx_v_detector_codes, __pyx_v_sigmas, __pyx_v_ntimes, __pyx_v_Ndet, __pyx_v_ra_grids, __pyx_v_dec_grids, __pyx_v_ngrid, __pyx_v_start_time, __pyx_v_end_time, __pyx_v_ntime_interp, __pyx_v_prior_mu, __pyx_v_prior_sigma, __pyx_v_nthread);
...
static PyObject *__pyx_pf_8sealcore_4Pycoherent_skymap_bicorr(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_coh_skymap_bicorr, __Pyx_memviewslice __pyx_v_time_arrays, __Pyx_memviewslice __pyx_v_snr_arrays, __Pyx_memviewslice __pyx_v_detector_codes, __Pyx_memviewslice __pyx_v_sigmas, __Pyx_memviewslice __pyx_v_ntimes, int __pyx_v_Ndet, __Pyx_memviewslice __pyx_v_ra_grids, __Pyx_memviewslice __pyx_v_dec_grids, int __pyx_v_ngrid, double __pyx_v_start_time, double __pyx_v_end_time, int __pyx_v_ntime_interp, double __pyx_v_prior_mu, double __pyx_v_prior_sigma, int __pyx_v_nthread) {
  ...
  /* "sealgw/calculation/cealcore.pyx":59
 ...
 */
  ...
  /* "sealgw/calculation/cealcore.pyx":62
 *
 *     coherent_skymap_bicorr(
 ...
 *                 double[:] time_arrays,
 */
  __pyx_tuple__24 = PyTuple_Pack(17, __pyx_n_s_coh_skymap_bicorr, __pyx_n_s_time_arrays, __pyx_n_s_snr_arrays, __pyx_n_s_detector_codes, __pyx_n_s_sigmas, __pyx_n_s_ntimes, __pyx_n_s_Ndet, __pyx_n_s_ra_grids, __pyx_n_s_dec_grids, __pyx_n_s_ngrid, __pyx_n_s_start_time, __pyx_n_s_end_time, __pyx_n_s_ntime_interp, __pyx_n_s_prior_mu, __pyx_n_s_prior_sigma, __pyx_n_s_nthread, __pyx_n_s_coh_skymap_bicorr_memview); if (unlikely(!__pyx_tuple__24)) __PYX_ERR(0, 37, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__24);
  __Pyx_GIVEREF(__pyx_tuple__24);
  __pyx_codeobj__25 = (PyObject*)__Pyx_PyCode_New(16, 0, 17, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__24, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_sealgw_calculation_cealcore_pyx, __pyx_n_s_Pycoherent_skymap_bicorr, 37, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__25)) __PYX_ERR(0, 37, __pyx_L1_error)
 ...
 *                 double[:] time_arrays,
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_8sealcore_5Pycoherent_skymap_bicorr, NULL, __pyx_n_s_sealcore); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 37, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_Pycoherent_skymap_bicorr, __pyx_t_1) < 0) __PYX_ERR(0, 37, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
