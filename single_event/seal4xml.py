...
def extract_info_from_xml(filepath):
    ...
    return trigger_time, ndet, det_code_array, max_snr_array, sigma_array, snr_series_list
...
if __name__ == "__main__":
    ...
    trigger_time, ndet, det_code_array, max_snr_array, sigma_array, snr_series_list =\
    ...
    sealcore.testLALseries(lal_data_list, ndet)
